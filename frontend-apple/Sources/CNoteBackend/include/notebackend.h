...
void notebackend_stack_push_bytes(const uint8_t *offset, size_t size);
int32_t notebackend_stack_last_i32(int32_t *ret);
int32_t notebackend_stack_last_str(const uint8_t **offset, size_t *size);
int32_t notebackend_stack_last_bytes(const uint8_t **offset, size_t *size);
...
int32_t notebackend_extract_meta(void);
int32_t notebackend_update_meta(void);
...
int32_t notebackend_export_snapshot(void);
