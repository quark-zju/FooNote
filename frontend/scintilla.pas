...
{
  Automatically converted by H2Pas 1.0.0 from Scintilla.h
...
function Scintilla_RegisterClasses(hInstance: pointer): longint;

function Scintilla_ReleaseResources: longint;
...
type
  ...
  SciFnDirect = function(ptr: sptr_t; iMessage: dword; wParam: uptr_t; lParam: sptr_t): sptr_t; cdecl;
...
type
  ...
  PSCNotification = ^SCNotification;
